...
public class LogRegression {
	...
	public static void main(String args[]) {
		...
		try {
			Table bank_data = Table.read().csv("C:\Tejuu\train.csv");
			...
			Instances train_data = getInstances("C:\Tejuu\train.csv.arff");
			Instances test_data = getInstances("C:\Tejuu\test.csv.arff");
